...
public class ShroomstoneShovelItem extends ShovelItem {
    public ShroomstoneShovelItem(IItemTier tier, float damage, float attackSpeed, Properties p_i48530_4_) {
