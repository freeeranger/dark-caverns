...
public final class PortSmokeTests {
    ...
    public static void registriesLoad(GameTestHelper helper) {
        ...
        verifyRegistryCount(helper, Registries.CONFIGURED_FEATURE, 32, "configured features");
        verifyRegistryCount(helper, Registries.PLACED_FEATURE, 31, "placed features");
