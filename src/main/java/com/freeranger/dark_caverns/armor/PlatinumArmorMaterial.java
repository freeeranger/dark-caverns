...
public enum PlatinumArmorMaterial implements IArmorMaterial {
    ...
    PLATINUM("platinum", 36, new int[]{3, 6, 8, 3}, 20, SoundEvents.ARMOR_EQUIP_DIAMOND, 2.5F, 0.0F, () -> {
    ...
    PlatinumArmorMaterial(String name, int durabilityMultiplier, int[] slotProtections, int enchantmentValue, SoundEvent sound, float toughness, float knockbackResistance, Supplier<Ingredient> repairIngredient) {
        this.name = name;
