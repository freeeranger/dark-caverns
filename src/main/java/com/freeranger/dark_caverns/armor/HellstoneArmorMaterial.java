...
public enum HellstoneArmorMaterial implements IArmorMaterial {
    ...
    HELLSTONE("hellstone", 37, new int[]{3, 6, 8, 3}, 15, SoundEvents.ARMOR_EQUIP_NETHERITE, 3F, 0.1F, () -> {
    ...
    HellstoneArmorMaterial(String name, int durabilityMultiplier, int[] slotProtections, int enchantmentValue, SoundEvent sound, float toughness, float knockbackResistance, Supplier<Ingredient> repairIngredient) {
        this.name = name;
