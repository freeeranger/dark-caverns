...
public final class CustomFeatures {
    public static final DeferredHolder<Feature<?>, Feature<NoneFeatureConfiguration>> CRACKED_BEDROCK =
    ...
    public static final DeferredHolder<Feature<?>, Feature<NoneFeatureConfiguration>> MOLTEN_SPIKE =
            ModRegistries.FEATURES.register(
                    ...
                    () -> new SpikeFeature(NoneFeatureConfiguration.CODEC, CustomBlocks.MOLTEN_CARFSTONE)
            );
