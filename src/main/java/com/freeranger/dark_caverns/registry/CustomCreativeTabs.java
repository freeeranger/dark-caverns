            ...
            ModRegistries.CREATIVE_TABS.register(
                    ...
                    () -> CreativeModeTab.builder()
                            ...
                            .displayItems((parameters, output) -> {
                                ...
                                output.accept(CustomBlocks.SMOOTH_CARFSTONE_STAIRS.get());
                                output.accept(CustomBlocks.SMOOTH_CARFSTONE_SLAB.get());
                                output.accept(CustomBlocks.SMOOTH_CARFSTONE_WALL.get());
                                output.accept(CustomBlocks.CARFSTONE_BRICK_STAIRS.get());
                                output.accept(CustomBlocks.CARFSTONE_BRICK_SLAB.get());
                                output.accept(CustomBlocks.CARFSTONE_BRICK_WALL.get());

                                output.accept(CustomBlocks.MOLTEN_CARFSTONE.get());
                                output.accept(CustomBlocks.SMOOTH_MOLTEN_CARFSTONE.get());
                                output.accept(CustomBlocks.MOLTEN_CARFSTONE_BRICKS.get());
                                output.accept(CustomBlocks.MOLTEN_CARFSTONE_STAIRS.get());
                                output.accept(CustomBlocks.MOLTEN_CARFSTONE_SLAB.get());
                                output.accept(CustomBlocks.MOLTEN_CARFSTONE_WALL.get());
                                output.accept(CustomBlocks.SMOOTH_MOLTEN_CARFSTONE_STAIRS.get());
                                output.accept(CustomBlocks.SMOOTH_MOLTEN_CARFSTONE_SLAB.get());
                                output.accept(CustomBlocks.SMOOTH_MOLTEN_CARFSTONE_WALL.get());
                                output.accept(CustomBlocks.MOLTEN_CARFSTONE_BRICK_STAIRS.get());
                                output.accept(CustomBlocks.MOLTEN_CARFSTONE_BRICK_SLAB.get());
                                output.accept(CustomBlocks.MOLTEN_CARFSTONE_BRICK_WALL.get());

                                output.accept(CustomBlocks.GLIMMERGRASS_BLOCK.get());
                                output.accept(CustomBlocks.CRACKED_BEDROCK.get());
                                output.accept(CustomBlocks.GATEWAY_TO_THE_CAVERNS.get());
                                output.accept(CustomBlocks.GATEWAY_TO_THE_OVERWORLD.get());

                                output.accept(CustomBlocks.CARFSTONE_COAL_ORE.get());
                                output.accept(CustomBlocks.CARFSTONE_IRON_ORE.get());
                                output.accept(CustomBlocks.CARFSTONE_GOLD_ORE.get());
                                output.accept(CustomBlocks.CARFSTONE_REDSTONE_ORE.get());
                                output.accept(CustomBlocks.CARFSTONE_LAPIS_ORE.get());
                                output.accept(CustomBlocks.CARFSTONE_DIAMOND_ORE.get());
                                ...
                                output.accept(CustomBlocks.GLIMMERSHROOM_BLOCK.get());
                                ...
                                output.accept(CustomItems.SHROOMSTONE_PICKAXE.get());
                                ...
                                output.accept(CustomItems.PLATINUM_CHESTPLATE.get());
                                ...
                                output.accept(CustomItems.HELLSTONE_CHESTPLATE.get());
                                ...
                                output.accept(CustomItems.SHROOMSTONE_CHESTPLATE.get());
                                output.accept(CustomItems.SHROOMSTONE_LEGGINGS.get());
                                output.accept(CustomItems.SHROOMSTONE_BOOTS.get());
                                output.accept(CustomItems.SCORCHSTEEL_HELMET.get());
                                output.accept(CustomItems.SCORCHSTEEL_CHESTPLATE.get());
                                output.accept(CustomItems.SCORCHSTEEL_LEGGINGS.get());
                                ...
                                output.accept(CustomItems.THROWABLE_LUMINITE_TORCH.get());
                                output.accept(CustomItems.SHROOMBOMB.get());
                                output.accept(CustomItems.CORRUPTED_PEARL.get());

                                output.accept(CustomItems.SCORCHLING_SPAWN_EGG.get());
                                output.accept(CustomItems.SCORCHHOUND_SPAWN_EGG.get());
                                output.accept(CustomItems.MOLTENER_SPAWN_EGG.get());
                                output.accept(CustomItems.CAMOROCK_SPAWN_EGG.get());
                                output.accept(CustomItems.LUMINITE_GOLEM_SPAWN_EGG.get());
                                output.accept(CustomItems.LUMINITE_FOX_SPAWN_EGG.get());
                                output.accept(CustomItems.SHROOMIE_SPAWN_EGG.get());
                                output.accept(CustomItems.SHROOMLING_SPAWN_EGG.get());
                            })
                            .build()
            );
